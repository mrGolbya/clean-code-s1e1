...
var createNewTaskElement = function (taskString) {
  ...
  label.className = "section__todo-task";

  //Each elements, needs appending
  checkBox.type = "checkbox";
  editInput.type = "text";
  editInput.className = "section__todo-task";

  editButton.innerText = "Edit"; //innerText encodes special characters, HTML does not.
  editButton.className = "section__todo-edit";

  deleteButton.className = "section__todo-delete";
...
var editTask = function () {
  ...
  var editBtn = listItem.querySelector(".section__todo-edit");
...
var bindTaskEvents = function (taskListItem, checkBoxEventHandler) {
  ...
  var editButton = taskListItem.querySelector("button.section__todo-edit");
  var deleteButton = taskListItem.querySelector("button.section__todo-delete");
